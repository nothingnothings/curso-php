...
$paymentStatus =  '1';  /// isso ainda funcionará, vai entrar no case de 1 (int)
...
// -> se trocamos O VALUE de paymentStatus PARA true,
...
switch ($paymentStatus) {
    case 1:
        echo 'Paid';
        break 2;  //* eis o código em questao (saímos do switch, e saímos do foreach loop)
    case 2:
    case 3:
        echo 'Payment Declined';
        break;
